...
void Homework19() {
	...
	unique_ptr<CharacterHW19> warrior = make_unique<CharacterHW19>();
	unique_ptr<CharacterHW19> thief = make_unique<CharacterHW19>();
	unique_ptr<CharacterHW19> shadow = make_unique<CharacterHW19>();
	unique_ptr<CharacterHW19> empty = make_unique<CharacterHW19>();

	unique_ptr<Weapon> sword = make_unique<Sword>("BIG DESTRUCTOR",30);
